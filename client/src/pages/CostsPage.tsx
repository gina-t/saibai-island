    ...
    <div className="relative isolate overflow-hidden bg-transparent px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-mt-12 -ml-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <figure>
            <img
            alt="Quote for flood barrier manufacturing from Warringah Plastics"
            src={Cost}
            ...
            <figcaption className="mt-8 text-sm text-gray-500 italic">
              ...
              Manufacturing cost quote for L-shaped flood barrier modules. From Warringah Plastics, Brookvale, NSW. Personal communication via email, October 2025.
            </figcaption>
          </figure>
        </div>
        {/* main content */}
